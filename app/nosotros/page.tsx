        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-12 bg-gray-900 p-8 rounded-lg">
            ...
            <p className="text-gray-300 mb-4">
              Artesano Digital nació en 2018 como un pequeño taller de diseño en Santiago de Chile, fundado por un grupo de
          ...
          <div className="mb-12 bg-gray-900 p-8 rounded-lg">
            ...
            <p className="text-gray-300">
              En Artesano Digital, nuestra misión es transformar espacios ordinarios en experiencias extraordinarias a
